...
<head>
    ...
    <title>Sobre a doença</title>
</head>

<body>
    <br>
    <main role="main" class="container">
        <h1 class="mt-5">COVID 19</h1>
        <br>
        ...
        <br>
        <h2><a id="transmissao"></a>Como é transmitido</h2>
        ...
        <br>
        <h2><a id="como-se-proteger"></a>Como se proteger</h2>
        ...
        <p><a href="http://portal.anvisa.gov.br/documents/219201/4340788/NT+M%C3%A1scaras.pdf/bf430184-8550-42cb-a975-1d5e1c5a10f7" target="_blank" rel="noopener noreferrer">Veja aqui como confeccionar e usar a máscara caseira.</a></p>
        <br>
        <h2>Dicas para viajantes</h2>
        <ul>
            <li>Caso você precise viajar, avalie a real necessidade. Se for inevitável viajar, previna-se e siga as orientações das autoridades de saúde locais.</li>
        </ul>
        <p>Ao voltar de viagens internacionais ou locais recomenda-se:</p>
        <ul>
            <li><strong>No caso de viagens internacionais</strong>: o isolamento domiciliar voluntário por 7 dias após o desembarque, mesmo que não tenha apresentado os sintomas.</li>
            <li><strong>No caso de viagens locais</strong>: ficar atento à sua condição de saúde, principalmente nos primeiros 14 dias.</li>
        ...
        <br>
        <h2><a id="se-eu-ficar-doente"></a>Se eu ficar doente</h2>
        <p>Caso você se sinta doente, com sintomas de gripe, evite contato físico com outras pessoas, principalmente idosos e doentes crônicos e fique em casa por 14 dias.<br /> Só procure um hospital de referência se estiver com falta de ar.</p>
        <p> Em caso de diagnóstico positivo para COVID-19, siga as seguintes recomendações:</p>
        <ul>
        ...
        <p>Caso o paciente não more sozinho, os demais moradores da devem dormir em outro cômodo, longe da pessoa infectada, seguindo também as seguintes recomendações:</p>
        <ul>
        ...
        <br>
        <h2><a id="servico-de-saude"></a>Serviço de Saúde</h2>
        <p>Procure um serviço de saúde apenas se apresentar falta de ar.</p>
        <p><a href="https://portalarquivos.saude.gov.br/images/pdf/2020/April/18/Hospitais-estaduais-CORONAV--RUS.pdf">Lista de hospitais que prestam atendimento em seu estado/município.</a></p>
        <p><a href="https://portalarquivos.saude.gov.br/images/pdf/2020/April/18/postos-de-sa--de-com-endere--o.pdf">Lista dos postos de saúde que prestam atendimento em seu estado/município.</a></p>
        <p><a href="https://portalarquivos.saude.gov.br/images/pdf/2020/May/25/lista-laboratorio.pdf">Laboratórios públicos de referência de testagem para coronavírus</a></p>
    </main>
    <br>
    <footer">
        <?php
