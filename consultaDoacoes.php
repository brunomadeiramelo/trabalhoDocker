...
$sql = "SELECT id, nome, cpf, email, valor, pagamento FROM doacao ORDER BY id";
$sqlSoma = "SELECT SUM valor FROM doacao";
                            ...
                            <tbody>
                                <?php while ($a = $con->fetch_array()) { ?>
                                    <tr>
                                        ...
                                        <td> <?php echo $a["pagamento"];  ?> </td>
                                    </tr>
                                <?php $total = $total + $a["valor"]; } ?>
                            </tbody>
                        </table>
                    </div>
                </div>
            </div>
            <p>Valor total recebido: <?php echo $total;  ?></p>
        </div>
